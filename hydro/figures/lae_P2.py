...
with open('lae_P2.json') as json_file:
    data = json.load(json_file)
    
with open('lae_P2_L1relError.json') as json_file:
...
ln_coll = matplotlib.collections.LineCollection(segs,colors=ctiM, linestyle='solid', capstyle='round')
ax01.add_collection(ln_coll)
