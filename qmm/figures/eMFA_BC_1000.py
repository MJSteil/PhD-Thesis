...
#ax.legend(numpoints=1,loc='upper right',facecolor='1',edgecolor='0.8',fancybox=True) 




ax.text(0.025, 0.045, "$\\mathrm{RG\ (in)consistent\ MF}\ (\\mathrm{BC}\mathrm{\ fitting})$\n$\Lambda'=0.4\,\mathrm{GeV},\,\Lambda=1.0\,\mathrm{GeV},\,\lambda_k^\\mathrm{exp}$\n$f_\pi=88\,\\mathrm{MeV},\,M_\psi=300\,\\mathrm{MeV},\,m_\sigma=600\,\\mathrm{MeV}$",
...
save_plot(fig,'eMFA_QMMCDW_PD_BC_04_10_88_300_600.pdf')
#plt.show()