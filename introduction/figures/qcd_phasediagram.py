...
img = mpimg.imread("qcd_phasediagram.png")
img_shape = img.shape
...
## Axes
ax00.set_xlabel("Net baryon number density $n\\left(n_0=0.16\,\mathrm{fm}^{-3}\\right)$")
ax00.set_xlim(0,12)
ax00.set_xticks([0,1.6,5.4,8],[0,1,5,8])


ax00.set_ylabel("Temperature $T\,(\mathrm{MeV})$")
...
plt.text(0.45,3.5,'Early universe',rotation=-90, ha='center', va='bottom',zorder=10, size=9, color=c[1])
ax00.arrow(0.15,2.85, 0, -0.01,**plot_styles[1], shape='full', lw=0, length_includes_head=True, head_width=.2)

# Neutron stars
plt.text(6.3,.2,'Neutron stars',rotation=0, ha='center', va='bottom',zorder=10, size=9, color=c[1])

## Phase diagram

plt.text(3.5,3,'Deconf. \&',rotation=-40, ha='center', va='bottom',zorder=10, size=9, color='0')
plt.text(4.5,2.25,'chiral',rotation=-50, ha='center', va='bottom',zorder=10, size=9, color='0')
plt.text(5.35,0.55,'transition?!',rotation=-60, ha='center', va='bottom',zorder=10, size=9, color='0')

plt.text(3.9,4.7,'Critical point?',rotation=-0, ha='center', va='bottom',zorder=10, size=9, color='0')
...
plt.text(9.9,.9,'Color super conductor',rotation=-0, ha='center', va='bottom',zorder=10, size=9, color='0')
...
plt.text(2.8,2.9,'Hadrons',rotation=-0, ha='center', va='bottom',zorder=10, size=9, color='0')
plt.text(2.8,2.9-0.5,'$\\langle\\bar{q}q\\rangle\\neq 0$',rotation=-0, ha='center', va='bottom',zorder=10, size=9, color='0')

plt.text(2.95,0.1,'Nuclear matter',rotation=-0, ha='center', va='bottom',zorder=10, size=9, color='0')
...
save_plot(fig, 'qcd_phasediagram.pdf',300)