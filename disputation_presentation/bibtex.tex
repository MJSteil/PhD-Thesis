...
\newcommand{\fncite}[1]{\cite{#1}\ \citefull{#1}}
\newcommand{\fncitec}[2]{\cite{#1}\ {#2}}
\newcommand{\fnciteay}[1]{\cite{#1}\ \citeauthoryear{#1}}
%\newcommand{\fncitemark}[1]{\textsuperscript{\cite{#1}}} % not used afterall

%DeclareCiteCommand{\simplecite}{}{\printfield{labelnumber}}{}{}

	
% ************ Bibliography *********** %
\bibliography{PhD-Disputationsvortrag}
...
% Font sizes
\renewcommand*{\bibfont}{\scriptsize} % general font for bibliography
\newcommand{\bibfontsmall}{\tiny} % smaller font for bibliography (used in URLs, DOIs, arXiv Links)

\setbeamerfont{bibliography entry author}{size=\bibfont,series=\normalfont}
\setbeamerfont{bibliography entry title}{size=\bibfont,series=\normalfont}
\setbeamerfont{bibliography entry location}{size=\bibfont,series=\normalfont}
\setbeamerfont{bibliography entry note}{size=\bibfont,series=\normalfont}
